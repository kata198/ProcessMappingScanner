...
shopt -s nullglob
ALL_MODS="$(echo ProcessMappingScanner/*.py | tr ' ' '\n' | sed -e 's|/|.|g' -e 's|.py$||g' -e 's|.__init__$||g' | tr '\n' ' ')"

pydoc -w ${ALL_MODS}
mv ProcessMappingScanner*.html doc/
...
if __name__ == '__main__':
    ...
    em.href = 'ProcessMappingScanner.html'
...
ln -s ProcessMappingScanner.html index.html
